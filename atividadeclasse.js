...
const gerente = new Gerente('Patrick', 35, 'Gerente', 'Tecnologia');
gerente.seApresentar();  
gerente.trabalhar();     
gerente.gerenciar();   

const desenvolvedor = new Desenvolvedor('Daniel', 19, 'desenvolvedorJunior', 'JavaScript');
desenvolvedor.seApresentar();  
desenvolvedor.trabalhar();     
desenvolvedor.programar();     


const aprendiz = new aprendiz ('DIONE', 21, 'desenvolvedorJunior', 'JavaScript');
desenvolvedor.seApresentar();  
desenvolvedor.trabalhar();     
desenvolvedor.programar();     
